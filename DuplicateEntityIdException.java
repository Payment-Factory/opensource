...
/**
 * An exception that indicates an attempt to add an Abstraction to the model with an id that is
 * already used in the model.
 * <P>
 * Note that the model will assign a unique id if you add the Abstraction to the model with an
 * entity id of zero.
 */
public class DuplicateEntityIdException extends ModelException {
