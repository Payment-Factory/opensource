...
/**
 * An exception that indicates that a sub-entity within an Abstraction could not be found.
 */
public class SubEntityNotFoundException extends AbstractionException {
