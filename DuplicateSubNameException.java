...
/**
 * An exception that indicates an attempt to add a sub-entity to an Abstraction, with a name that
 * is already in use.
 */
public class DuplicateSubNameException extends AbstractionException {

  /**
   * Standard constructor - builds an exception with the specified message.
   * @param message A string describing the exception;
   */
  public DuplicateSubNameException(String message) {
    super(message);
  }
